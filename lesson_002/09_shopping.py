...
print("Конфеты в магазине", sweets['конфеты'][0]['shop'], "стоят", sweets['конфеты'][0]['price'], "руб.")
print("Конфеты в магазине", sweets['конфеты'][1]['shop'], "стоят", sweets['конфеты'][1]['price'], "руб.")
